...
"use strict";var influxdb=(()=>{var ye=Object.defineProperty;var Kt=Object.getOwnPropertyDescriptor;var Gt=Object.getOwnPropertyNames;var Zt=Object.prototype.hasOwnProperty;var j=(n=>typeof require!="undefined"?require:typeof Proxy!="undefined"?new Proxy(n,{get:(e,t)=>(typeof require!="undefined"?require:e)[t]}):n)(function(n){if(typeof require!="undefined")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var zt=(n,e)=>{for(var t in e)ye(n,t,{get:e[t],enumerable:!0})},Qt=(n,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Gt(e))!Zt.call(n,i)&&i!==t&&ye(n,i,{get:()=>e[i],enumerable:!(r=Kt(e,i))||r.enumerable});return n};var Yt=n=>Qt(ye({},"__esModule",{value:!0}),n);var xr={};zt(xr,{AbortError:()=>v,DEFAULT_ConnectionOptions:()=>er,DEFAULT_WriteOptions:()=>Fe,GetFieldTypeMissmatchError:()=>Z,HttpError:()=>k,IllegalArgumentError:()=>_,InfluxDBClient:()=>H,Log:()=>D,Point:()=>V,PointValues:()=>S,RequestTimedOutError:()=>we,collectAll:()=>bt,consoleLogger:()=>st,convertTime:()=>_e,convertTimeToNanos:()=>Ee,createTextDecoderCombiner:()=>Te,currentTime:()=>pt,dateToProtocolTimestamp:()=>mt,escape:()=>U,fromConnectionString:()=>xe,fromEnv:()=>Oe,setLogger:()=>tr,useProcessHrtime:()=>ct,writableDataToLineProtocol:()=>Se});var _=class n extends Error{constructor(e){super(e),this.name="IllegalArgumentError",Object.setPrototypeOf(this,n.prototype)}},k=class n extends Error{constructor(t,r,i,s,o){super();this.statusCode=t;this.statusMessage=r;this.body=i;this.contentType=s;if(Object.setPrototypeOf(this,n.prototype),o)this.message=o;else if(i){if(s!=null&&s.startsWith("application/json"))try{this.json=JSON.parse(i),this.message=this.json.message,this.code=this.json.code}catch(a){}this.message||(this.message=`${t} ${r} : ${i}`)}else this.message=`${t} ${r}`;this.name="HttpError"}},we=class n extends Error{constructor(){super(),Object.setPrototypeOf(this,n.prototype),this.name="RequestTimedOutError",this.message="Request timed out"}},v=class n extends Error{constructor(){super(),this.name="AbortError",Object.setPrototypeOf(this,n.prototype),this.message="Response aborted"}};function Te(){let n=new TextDecoder("utf-8");return{concat(e,t){let r=new Uint8Array(e.length+t.length);return r.set(e),r.set(t,e.length),r},copy(e,t,r){let i=new Uint8Array(r-t);return i.set(e.subarray(t,r)),i},toUtf8String(e,t,r){return n.decode(e.subarray(t,r))}}}var er={timeout:1e4},Fe={precision:"ns",gzipThreshold:1e3};function xe(n){let e={host:n.split("?")[0]},t=new URL(n);return t.searchParams.has("token")&&(e.token=t.searchParams.get("token")),t.searchParams.has("database")&&(e.database=t.searchParams.get("database")),t.searchParams.has("timeout")&&(e.timeout=parseInt(t.searchParams.get("timeout"))),t.searchParams.has("precision")&&(e.writeOptions||(e.writeOptions={}),e.writeOptions.precision=t.searchParams.get("precision")),t.searchParams.has("gzipThreshold")&&(e.writeOptions||(e.writeOptions={}),e.writeOptions.gzipThreshold=parseInt(t.searchParams.get("gzipThreshold"))),e}function Oe(){if(!process.env.INFLUX_HOST)throw Error("INFLUX_HOST variable not set!");if(!process.env.INFLUX_TOKEN)throw Error("INFLUX_TOKEN variable not set!");let n={host:process.env.INFLUX_HOST};return process.env.INFLUX_TOKEN&&(n.token=process.env.INFLUX_TOKEN),process.env.INFLUX_DATABASE&&(n.database=process.env.INFLUX_DATABASE),process.env.INFLUX_TIMEOUT&&(n.timeout=parseInt(process.env.INFLUX_TIMEOUT)),process.env.INFLUX_PRECISION&&(n.writeOptions||(n.writeOptions={}),n.writeOptions.precision=process.env.INFLUX_PRECISION),process.env.INFLUX_GZIP_THRESHOLD&&(n.writeOptions||(n.writeOptions={}),n.writeOptions.gzipThreshold=parseInt(process.env.INFLUX_GZIP_THRESHOLD)),n}var st={error(n,e){console.error(`ERROR: ${n}`,e||"")},warn(n,e){console.warn(`WARN: ${n}`,e||"")}},K=st,D={error(n,e){K.error(n,e)},warn(n,e){K.warn(n,e)}};function tr(n){let e=K;return K=n,e}function Ie(n,e){return function(t){let r="",i=0,s=0;for(;s<t.length;){let o=n.indexOf(t[s]);o>=0&&(r+=t.substring(i,s),r+=e[o],i=s+1),s++}return i==0?t:(i<t.length&&(r+=t.substring(i,t.length)),r)}}function rr(n,e){let t=Ie(n,e);return r=>`"${t(r)}"`}var U={measurement:Ie(`, 
\r	`,["\\,","\\ ","\\n","\\r","\\t"]),quoted:rr('"\\',['\\"',"\\\\"]),tag:Ie(`, =
...
`),m,c),l}async close(){this._closed=!0}};var ge=j("apache-arrow");var Jt=j("@protobuf-ts/runtime-rpc");function P(n){let e=typeof n;if(e=="object"){if(Array.isArray(n))return"array";if(n===null)return"null"}return e}function Ae(n){return n!==null&&typeof n=="object"&&!Array.isArray(n)}var E="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split(""),z=[];for(let n=0;n<E.length;n++)z[E[n].charCodeAt(0)]=n;z["-".charCodeAt(0)]=E.indexOf("+");z["_".charCodeAt(0)]=E.indexOf("/");function Ft(n){let e=n.length*3/4;n[n.length-2]=="="?e-=2:n[n.length-1]=="="&&(e-=1);let t=new Uint8Array(e),r=0,i=0,s,o=0;for(let a=0;a<n.length;a++){if(s=z[n.charCodeAt(a)],s===void 0)switch(n[a]){case"=":i=0;case`
...
`,H=class{constructor(...e){this._mergeWriteOptions=e=>({...this._options.writeOptions,...e});let t;switch(e.length){case 0:{t=Oe();break}case 1:{if(e[0]==null)throw new _("No configuration specified!");typeof e[0]=="string"?t=xe(e[0]):t=e[0];break}default:throw new _("Multiple arguments specified!")}this._options=t;let r=this._options.host;if(typeof r!="string")throw new _("No host specified!");if(r.endsWith("/")&&(this._options.host=r.substring(0,r.length-1)),typeof this._options.token!="string")throw new _("No token specified!");this._queryApi=new X(this._options),this._writeApi=new q(this._options)}async write(e,t,r,i){var s;await this._writeApi.doWrite(Se(e),(s=t!=null?t:this._options.database)!=null?s:G(new Error(it)),r,this._mergeWriteOptions(i))}query(e,t,r="sql"){var i;return this._queryApi.query(e,(i=t!=null?t:this._options.database)!=null?i:G(new Error(it)),r)}queryPoints(e,t,r="sql"){var i;return this._queryApi.queryPoints(e,(i=t!=null?t:this._options.database)!=null?i:G(new Error(it)),r)}async close(){await this._writeApi.close(),await this._queryApi.close()}};return Yt(xr);})();
